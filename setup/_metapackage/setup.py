...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo11-addon-maintenance_equipment_contract',
        ...
        'odoo11-addon-maintenance_plan_activity',
        'odoo11-addon-maintenance_remote',
        'odoo11-addon-maintenance_request_sequence',
        'odoo11-addon-maintenance_request_stage_transition',

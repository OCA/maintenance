...
class MaintenanceRequest(models.Model):
    ...
    checklist_ids = fields.One2many("maintenance.checklist", "request_id", "Checklists")
    total_checklist = fields.Float("Total Checklist", compute="_compute_checklists")
    ...
    def _compute_checklists(self):
        for maintenance in self:
            maintenance.total_checklist = len(maintenance.checklist_ids)
